    ...
    public partial class InitialIdentityAndDomain : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    MonthlyExpenseLimit = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Expenses_Employees_DecidedByEmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Expenses_DecidedByEmployeeId",
                table: "Expenses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Expenses_TenantId_Status_SubmittedAt",
                table: "Expenses",
